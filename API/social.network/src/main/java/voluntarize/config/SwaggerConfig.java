...
public class SwaggerConfig {
    ...
    public OpenAPI customAPI(){
        return new OpenAPI().info(new Info().title("Voluntari.ze").version("1.0.0")
                .license(new License().name("Licença do Sistema").url("www.Voluntari.ze"))
        );
    }
}
