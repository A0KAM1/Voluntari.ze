...
INSERT INTO POSTS (CONTENT, CREATED_AT, UPDATED_AT, ONG_ID) VALUES ('Live de doações para o RS. Entre, curta um som, e ajude o RS. Participação de vários cantores e DJs, terá duração', '2024-05-01 08:55:33.704', null, 2);
INSERT INTO POSTS (CONTENT, CREATED_AT, UPDATED_AT, ONG_ID) VALUES ('Conseguimos arrecadar bastante dinheiro na live de ontem, obrigado a todos que participaram, seja apenas assistindo, divulgando, ou doando para o caixinha <3. Todo esse dinheiro será usado para mandar remédios e alimentos não perecíveis para as famílias que estão desabrigadas ainda devido a grande enchente de maio.', '2024-05-03 08:55:33.704', null, 2);
INSERT INTO POSTS (CONTENT, CREATED_AT, UPDATED_AT, ONG_ID) VALUES ('Nós atualmente abrigamos 16 crianças e adolescentes que se encontravam em situações precárias. Precisamos muito da doação de vocês, o dinheiro é convertido principalmete em alimentos e remédios, assim como aluguel e contas do nosso abrigo. Obrigado <3', '2024-06-01 08:55:33.704', null, 3);
INSERT INTO POSTS (CONTENT, CREATED_AT, UPDATED_AT, ONG_ID) VALUES ('Pulga é nossa nova integrante! Foi resgatada semana passada e estava com muito frio e fome... Foi tratada e hoje está muito bem, fazendo amizade com todos <3', '2024-06-04 08:55:33.704', null, 1);
INSERT INTO POSTS (CONTENT, CREATED_AT, UPDATED_AT, ONG_ID) VALUES ('Vamos fazer um evento para arrecadar fundos na próxima sexta feira. Nossos amigos vão estar lá para que vocês possam conhece-los, e quem sabe levar um novo integrante para a família! Precisamos de voluntarios para fazer cachorro quente, e preencher formulários', '2024-06-05 08:55:33.704', null, 1);

INSERT INTO PUBLICATIONS (POST_ID) VALUES (2);
INSERT INTO PUBLICATIONS (POST_ID) VALUES (3);
INSERT INTO PUBLICATIONS (POST_ID) VALUES (4);

INSERT INTO EVENTS (ADDRESS, DATE, REQUIREMENTS, TIME, POST_ID, STATUS_ID) VALUES ('Nossas redes sociais', '2024-05-02', 'Nenhum', '08:00:00', 1, 2);
INSERT INTO EVENTS (ADDRESS, DATE, REQUIREMENTS, TIME, POST_ID, STATUS_ID) VALUES ('Em frente à igreja Matriz', '2024-06-14', 'Disponibilidade de voluntariar durante a tarde', '12:00:00', 5, 1);
